...
parfor img_idx = 1:120
    ...
    for k = 1 : 1
		...
		imwrite(mat2gray(saliency_map_),sprintf('/home/shenchong/work/saliency/Results_cs_all/%d_%d_%d_%d.jpg',img_idx,each_image_patches,R,r));
    end
    disp(img_idx);
    % clear all;
    % end

function mini_sal = func_sal(mini_image,R,r,w1,w2,w3,w4,w5,w6,w7,w8,w9,w10,w_class)
...
saliency_map_matrix = sqrt(sum((data1-dataout).^2, 2));
% saliency_map_matrix = sum(abs(data1-dataout), 2);
mini_sal = reshape(saliency_map_matrix, [cols-2*R, rows-2*R])';
